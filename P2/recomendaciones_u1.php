...
<html lang="en">
  ...
  <body>
    ...
    <main>
      <section class="row">
        <section class="five columns" id="tituloizquierda">
          <h4>Recomendado para ti</h4>
        </section>
        <section class="five columns" id="tituloderecha">
      ...
      <!-- Section-->
      <section class="row">
        <section class="six columns" id="izquierda">
          <section class="row">
            <section class="five columns">
              <img alt="libro" src="images/libro5.jpg" />
            </section>
            <section class="six columns librosindex">
              <h5 class="right"><a href="libro1.html"> Titulo 1</a></h5>
          ...
          <section class="row">
            ...
            <section class="six columns librosindex">
              <h5 class="right"><a href="libro2.html"> Titulo 2</a></h5>
              <h5 class="right">Autor 2</h5>
            </section>
          </section>
          <section class="row">
            <section class="five columns">
            ...
            <section class="six columns librosindex">
              <h5 class="right"><a href="#"> Titulo 3</a></h5>
              <h5 class="right">Autor 3</h5>
            </section>
          </section>
          <section class="row">
            <section class="five columns">
            ...
            <section class="six columns librosindex">
              <h5 class="right"><a href="#"> Titulo 1</a></h5>
              <h5 class="right">Autor 1</h5>
            </section>
          </section>
          <section class="row">
        ...
        <!-- Book column-->
        <section class="six columns" id="derecha">
          <section class="row">
            <section class="five columns">
              <img alt="libro" src="images/libro5.jpg" />
            </section>
